...
The SQL queries used to inspect and clean the data for this analysis can be found [here](https://github.com/gedaipek/SQL-project/blob/main/scripts/SQL/Example%20Data%20Quality%20Checks..sql).
